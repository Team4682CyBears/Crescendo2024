...
public class DrivetrainSubsystem extends SubsystemBase {
  ...
  public static final double MAX_ANGULAR_VELOCITY_RADIANS_PER_SECOND = (MAX_VELOCITY_METERS_PER_SECOND/2.0) /
  ...
  public Rotation2d getGyroscopeRotation() {
    ...
    */
    ...
    // Restore angle modulus (this had been removed before in NavX2 testing, but it was a red herring)
    return Rotation2d.fromRadians(
      MathUtil.angleModulus(
  ...
  */
  ...
  private ChassisSpeeds limitChassisSpeedsAccel(ChassisSpeeds speeds) {
    ...
    if(omegaVelocityLimited < previousChassisSpeeds.omegaRadiansPerSecond) {
      omegaVelocityLimited = limitAxisSpeed(
        speeds.omegaRadiansPerSecond,
        this.previousChassisSpeeds.omegaRadiansPerSecond,
        this.MAX_ANGULAR_DECELERATION_RADIANS_PER_SECOND_SQUARED);
    }
