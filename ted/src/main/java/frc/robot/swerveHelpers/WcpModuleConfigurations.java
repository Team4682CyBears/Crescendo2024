...
public class WcpModuleConfigurations {
    public static final ModuleConfiguration BABYBEAR = new ModuleConfiguration(
            0.1016,  //4" in meters
    ...
    public static final ModuleConfiguration TED = new ModuleConfiguration(
            0.1016,  //4" in meters
            1/5.46, // 5.46:1 (12:34 -> 28:18 -> 15:45)
            true, //three reductions
            1/15.43, // 15.43:1 (8:24 -> 14:72)
            false //two reductions
    );
