...
public final class Constants {
    ...
    public static final double shooterControllerInputPositiveStickAngleIncrement = 0.1;
    public static final double shooterControllerInputNegativeStickAngleIncrement = -0.1;
