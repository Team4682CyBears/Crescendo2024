...
public final class Constants {
    ...
    // Falcon 500 max speed is 6380 RPM, but max loaded speed is 5600 deteremined from testing, but 5000 is a more comfortable max
    public static double shooterMaxRpm = 5000;
