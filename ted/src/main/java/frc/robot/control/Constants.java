...
public final class Constants {
    ...
    public static final double shooterAngleStickIncrementMagnitude = Constants.shooterAngleToleranceDegrees + 0.4;
    public static final double shooterAngleStickIncrementMagnitudeMaximum = 20;
